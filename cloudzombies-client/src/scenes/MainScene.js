...
export class MainScene extends Scene {
    ...
    create() {
        ...
        const floorMask = this.physics.add.staticBody(0, this.scale.height, floor.getBounds().width, floor.getBounds().height - 10)
        this.physics.add.existing(floor, true)
        // Player
        this.player = new Player({ scene: this });
        this.physics.add.collider(this.player, floorMask)
        // Enemy
